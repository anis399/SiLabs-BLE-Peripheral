...
GATT_DATA(sli_bt_gattdb_attribute_chrvalue_t gattdb_attribute_field_10) = {
  ...
  .max_len = 8,
  .len = 8,
  .data = { 0x41, 0x6e, 0x69, 0x73, 0x58, 0x58, 0x58, 0x58, }
};
...
GATT_DATA(const sli_bt_gattdb_attribute_t gattdb_attributes_map[]) = {
  ...
  { .handle = 0x15, .uuid = 0x8000, .permissions = 0xf02, .caps = 0xffff, .state = 0x00, .datatype = 0x01, .dynamicdata = &gattdb_attribute_field_20 },
  ...
  { .handle = 0x17, .uuid = 0x8001, .permissions = 0x7800, .caps = 0xffff, .state = 0x00, .datatype = 0x01, .dynamicdata = &gattdb_attribute_field_22 },
